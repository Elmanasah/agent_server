            ...
            if (!isAuthenticated) {
                try {
                    ...
                    if (authData.jwt_token) {
                        ...
                        console.warn('[proxy] Legacy bearer_token auth — tools disabled for this session');
                        authResult = {
                    ...
                    const serviceUrl = authResult.serviceUrl || authData.service_url || DEFAULT_SERVICE_URL;
                    ...
                    if (serviceUrl.includes('aiplatform.googleapis.com')) {
                        ...
                        try {
                            ...
                            console.warn('[proxy] Could not get SA token, using client token:', authErr.message);
